...
const yearInventors = inventors.map((inventor) =>{
  return inventor.year
})

console.log(yearInventors)
...
const completeNameInventors = inventors.map((inventor) => {
  return `${inventor.first} ${inventor.last}`
})

console.log(completeNameInventors)
...
const lastNameEdison = inventors.find((inventor) => {
  return inventor.last === 'Edison'
})

console.log(lastNameEdison)